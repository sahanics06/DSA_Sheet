...
void MinHeap::insertKey(int k) 
{
    ...
    heap_size++;
    int i=heap_size-1;
    harr[i]=k;          // We can also place "k" in the last index and then call heapify rather than using while loop. But calling heapify is not efficient.
    while(i!=0 && harr[i]<harr[parent(i)])        // So we have used while loop
    {
