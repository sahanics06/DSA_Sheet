...
column and ending on the rightmost column. There may be multiple nodes in the same row and same column. 
...
// Solution using map of map and multiset where we store values of each column based on row index.
